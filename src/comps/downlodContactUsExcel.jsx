...
const handleDownloadContactUsExcel = async () => {
  try {
    const response = await axios.get('http://localhost:8081/contact/getAll');
...
export default handleDownloadContactUsExcel;