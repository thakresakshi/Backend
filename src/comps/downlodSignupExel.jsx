...
const handleDownloadSignupExcel = async () => {
  try {
    const response = await axios.get('http://localhost:8081/signUp/getAll');
...
export default handleDownloadSignupExcel;